...
export const GEMINI_SYSTEM_PROMPT =
    ...
    "The bot tracks real-time ELO leaderboards sourced from lmarena.ai across categories " +
    "such as coding, math, creative writing, instruction following, and multiturn dialogue. " +
...
export const SCORE_LABEL: Record<string, (score: number) => string> = {
    "swe-bench": (s) => `🧪 SWE-bench: <b>${(s * 100).toFixed(1)}%</b>`,
    github: (s) => `⭐ Stars: <b>${s}k</b>`,
};
